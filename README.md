...
- GUI: Updated for SFML 3.0 compatibility; enabled window resizing; added caffeine stats and warnings; implemented dynamic vertical centering; changed Backspace to only erase text (navigation uses Left arrow).
